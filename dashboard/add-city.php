...
<title>Traveller Inn Dashboard | Add City</title>
</head>
<body>
            ...
            <div class="col-md-10">
                <div id="left-content" class="m-5 bg-light">
                    <div class="col-md-6 p-5">
                        <h5 class="font-weight-bold mb-3">Add New City</h5>
                        <form action="" method="POST">
                            <div class="form-group">
                                <label for="name">City Name</label>
                                <input type="text" name="c_name" id="name" class="form-control">
                            </div>
                            <input type="submit" value="add city" name="add-city" class="btn btn-success up-c">
                        </form>
                    </div>
