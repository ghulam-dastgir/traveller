                ...
                <div id="left-content" class="m-5">
                    <div class="shadow-lg">
                        <div class="table-header bg-info clearfix p-3">
                            <h4 class="float-left text-white ml-2">List Of Cities</h4>
                            <a href="add-city.php" class="btn btn-light text-info float-right mr-3"><i class="fa fa-plus"></i></a>
                        </div>
                            ...
                            <table class="table table-sm table-bordered table-striped text-center">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td>sunny rajpoot</td>
                                        <td><a href="" class="btn btn-sm btn-danger"><i class="fa fa-trash mr-1"></i></a>
                                        <a href="edit-city.php" class="btn btn-sm btn-success"><i class="fa fa-pen"></i></a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>2</td>
